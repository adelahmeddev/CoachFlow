...
export const SAMPLE_MEALS_KAMEL: MealInput[] = [
  {
    ...
    items: [
      { foodName: "Oats", foodNameAr: "شوفان", amount: 60, unit: g, calories: null },
      { foodName: "Baladi bread", foodNameAr: "عيش بلدي", amount: 120, unit: g, calories: null },
      { foodName: "Cottage cheese", foodNameAr: "جبن قريش", amount: 150, unit: g, calories: null },
      { foodName: "Whole eggs", foodNameAr: "بيض كامل", amount: 3, unit: pcs, calories: null },
      { foodName: "Skim milk", foodNameAr: "لبن خالي الدسم", amount: 250, unit: QuantityUnit.ML, calories: null },
      { foodName: "Apple", foodNameAr: "تفاح", amount: 150, unit: g, calories: null },
      { foodName: "Tomato + cucumber", foodNameAr: "طماطم وخيار", amount: null, unit: g, calories: null },
    ],
  },
  {
    kind: MealKind.SNACK,
    ...
    items: [
      { foodName: "Greek yogurt", foodNameAr: "زبادي يوناني", amount: 170, unit: g, calories: null },
      { foodName: "Banana", foodNameAr: "موز", amount: 120, unit: g, calories: null },
      { foodName: "Whey scoop", foodNameAr: "سكوب واي", amount: 1, unit: pcs, calories: null },
      { foodName: "Apple", foodNameAr: "تفاح", amount: 180, unit: g, calories: null },
    ],
  },
  {
    kind: MealKind.SNACK,
    ...
    items: [
      { foodName: "Medium banana", foodNameAr: "موسة وسط", amount: 1, unit: pcs, calories: null },
      { foodName: "Black coffee", foodNameAr: "قهوة سادة", amount: 1, unit: pcs, calories: null },
    ],
  },
  {
    kind: MealKind.MEAL,
    ...
    nameAr: "وجبة 2 الغدا",
    items: [
      { foodName: "Grilled or boiled chicken", foodNameAr: "فراخ مشوية أو مسلوقة", amount: 200, unit: g, calories: null },
      { foodName: "Diet tuna", foodNameAr: "تونة دايت", amount: 220, unit: g, calories: null },
      { foodName: "Cooked rice", foodNameAr: "أرز مطبوخ", amount: 250, unit: g, calories: null },
      { foodName: "Oven potatoes", foodNameAr: "بطاطس فرن", amount: 350, unit: g, calories: null },
      { foodName: "Big salad + olive oil spoon", foodNameAr: "سلطة كبيرة + معلق زيت زيتون", amount: 15, unit: g, calories: null },
    ],
  },
  {
    kind: MealKind.MEAL,
    ...
    nameAr: "وجبة 3 العشا",
    items: [
      { foodName: "Cottage cheese", foodNameAr: "جبن قريش", amount: 250, unit: g, calories: null },
      { foodName: "Tuna", foodNameAr: "تونة", amount: 150, unit: g, calories: null },
      { foodName: "Baladi bread", foodNameAr: "عيش بلدي", amount: 60, unit: g, calories: null },
      { foodName: "Brown toast", foodNameAr: "توست أسمر", amount: 4, unit: pcs, calories: null },
      { foodName: "Vegetable salad", foodNameAr: "سلطة خضار", amount: null, unit: g, calories: null },
    ],
  },
]
