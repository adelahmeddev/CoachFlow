...
function DialogOverlay({
  ...
  return (
    <DialogPrimitive.Overlay
      ...
      className={cn(
        "fixed inset-0 isolate z-50 bg-foreground/40 duration-100 backdrop-blur-[2px] data-open:animate-in data-open:fade-in-0 data-closed:animate-out data-closed:fade-out-0 dark:bg-black/70",
        className
      )}
      {...props}
    />
  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          "fixed z-50 grid w-full gap-4 glass-modal p-6 text-sm text-popover-foreground duration-100 outline-none data-open:animate-in data-open:fade-in-0 data-closed:animate-out data-closed:fade-out-0",
          /* Mobile: bottom sheet */
      ...
      >
        ...
        {showCloseButton && (
          <DialogPrimitive.Close data-slot="dialog-close" asChild>
            <Button
              variant="ghost"
              className="absolute top-2 end-2 min-h-[44px] min-w-[44px]"
              size="icon-sm"
    ...
    >
      ...
      {showCloseButton && (
        <DialogPrimitive.Close asChild>
          <Button variant="outline" className="min-h-[44px]">{t.common.close}</Button>
        </DialogPrimitive.Close>
      )}
    </div>
  )
